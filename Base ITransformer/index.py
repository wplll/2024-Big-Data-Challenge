...
def invoke(inputs):
    ...
    for i in range(2):
        ...
        covariate = make_feature(covariate)
        ...
        if i == 0:
            ...
            model.load_state_dict(torch.load("/home/mw/project/checkpoints/v1_iTransformer_Meteorology_ftMS_sl168_ll1_pl24_dm64_nh1_el1_df64_global_temp/checkpoint_4.pth"))
        else:
            model = iTransformer.Model(args).cuda()
